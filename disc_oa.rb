...

{
  ...
  help: { body: 'Convert a Google Discovery doc into an OpenAPI 3.x spec with optional validation and multiple return modes.' },
  ...
  actions: {
    discovery_to_openapi: {
      ...
      help: lambda do 
        body: 'Provide either Discovery JSON or URL (not both); choose return mode; outputs OpenAPI JSON/spec plus a validation report.'
      end,
